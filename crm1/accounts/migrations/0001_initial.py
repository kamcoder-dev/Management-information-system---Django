# Generated by Django 3.0.6 on 2020-07-16 19:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_name', to='accounts.Product')),
                ('product_sku', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orderproduct_sku', to='accounts.Product')),
